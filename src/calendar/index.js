...
class Calendar extends Component {
  ...
  render() {
    ...
    const customHeightStyle = dynamicHeight
      ? {height: weeks.length * WEEKS_HEIGHT + WEEKS_HEIGHT}
      : {};

    return (
      <View
        style={[this.style.container, this.props.style, {customHeightStyle}]}
